...
public class UserEncryptionServiceTest {
    ...
    private final User admin = new User("anAdmin", new User.Password("hisPassword"), IUser.Role.ADMIN);
    ...
    public void aPasswordShouldBeEncryptedWhenCreated() throws Exception {
        ...
        User client = new User("aClient", new User.Password("hisPassword"), IUser.Role.CLIENT);
